...
public class MarketCommand extends DetailedCommand {
    ...
    public MarketCommand(MarketManager marketManager) {
        ...
        setCommandDetails(CommandDetails.from("market,m", "Buy and sell resources at a given quantity on the market", "market sell [resources] for [price]"));
            ...
            offer.getUser(e.getJDA(), seller -> {
                if (seller.equals(e.getAuthor())) {
                    ...
                    if (buyingResource.get(e.getAuthor()) >= buyingQuantity) {
                        ...
                        op.sendMessage(
                                e, "market", ":white_check_mark: successfully bought **" + sellingResource.prettyValue(sellingQuantity) + "** for **"
